...
email_for_code = "pythontesting1219@gmail.com"
...
def options():
    ...
    if feature_to_run.strip() == '1' or feature_to_run.strip().lower() == 'one':
        ...
        try:
            ...
            print(
                'You have to have an email and a master password set up to use this feature.')
            options()
